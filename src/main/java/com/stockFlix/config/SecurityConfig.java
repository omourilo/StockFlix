...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
            ...
            .requestMatchers(HttpMethod.POST, "/previsoes/**").hasRole("ADMIN")
            .requestMatchers(HttpMethod.PUT, "/previsoes/**").hasRole("ADMIN")
            .requestMatchers(HttpMethod.DELETE, "/previsoes/**").hasRole("ADMIN")
            .requestMatchers(HttpMethod.GET, "/previsoes/**").authenticated()
